...
class Game:
    def __init__(self):
        ...
        self.create_mutiple_obstacles(*self.obstacle_x_position, x_start = screen_width / 15, y_start = 580)
        ...
        self.lives = 3
        self.live_surf = pygame.image.load('Figures/ship2.png').convert_alpha()
        self.live_x_start_pos = screen_width - (self.live_surf.get_size()[0] * 2 + 20)
        self.score = 0
        self.font = pygame.font.Font('Fonts/pixeltype.ttf', 30)

        #audio
        music = pygame.mixer.Sound('Music/space.ogg')
        music.set_volume(0.4)
        music.play(loops = -1)
        self.laser_sound = pygame.mixer.Sound('Music/laser_shot.wav')
        ...
        for row_index, row in enumerate(self.shape):
            for col_index, col in enumerate(row):
                if col == 'x':
                    ...
                    block = obstacle.Block(self.block_size, (235, 152, 52), x, y)
